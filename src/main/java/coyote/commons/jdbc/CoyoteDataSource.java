...
public class CoyoteDataSource implements DataSource, Closeable {
  ...
  private final DataSourceConfig configuration = new DataSourceConfig();
  ...
  public CoyoteDataSource() {}




  public CoyoteDataSource( DataSourceConfig config ) {
    this.setConfiguraton( config );
  }
  ...
  public void setConfiguraton( DataSourceConfig config ) {
    configuration.clear();
